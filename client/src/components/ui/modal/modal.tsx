import { ModalProps } from "@/components/ui/modal/modal-toggle";
import { Dialog, Transition } from "@headlessui/react";
import { Fragment } from "react";
import { MdClose } from "react-icons/md";
import { twMerge } from "tailwind-merge";

export type IModalProps = ModalProps & React.ComponentPropsWithoutRef<"div">;
    ...
    <Transition appear show={isModalOpen} as={Fragment}>
      <Dialog as="div" className="relative z-50" onClose={toggleModal}>
        <Transition.Child
          ...
          leaveTo="opacity-0"
        >
          <div className="fixed inset-0 bg-white/[0.5]" />
        </Transition.Child>
              ...
              >
                ...
                {actions && (
                  <div className="mt-4 flex justify-end space-x-2">
                    ...
                    <button className="rounded-md" onClick={toggleModal}>
                      Proceed
                    </button>
                  </div>
                )}
